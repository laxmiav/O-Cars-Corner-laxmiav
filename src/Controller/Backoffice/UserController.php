...
class UserController extends AbstractController
{
     ...
     */
    public function new(Request $request, UserRepository $userRepository,UserPasswordHasherInterface $hasher,EntityManagerInterface $entityManager): Response
    {
        $user = new User();
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            // permet de récupérer un champ non mappé
            // dump($form->get('toto')->getData());
